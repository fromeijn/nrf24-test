#define RF24_CLK_PIN		PIN1_bm
#define RF24_MISO_PIN		PIN2_bm
#define RF24_MOSI_PIN		PIN3_bm
#define RF24_NCS_PIN		PIN5_bm
#define RF24_IRQ_PIN		PIN6_bm
#define RF24_CE_PIN			PIN7_bm
#define RF24_USART_SPI_PORT	PORTC
#define RF24_OTHERS_PORT	PORTF

#define RF24_SS_SET (RF24_OTHERS_PORT.OUTCLR = RF24_NCS_PIN)
#define RF24_SS_CLR (RF24_OTHERS_PORT.OUTSET = RF24_NCS_PIN)
